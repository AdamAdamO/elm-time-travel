...
var savardd$elm_time_travel$Sandbox$config = {modelToString: elm$core$Debug$toString, msgToString: elm$core$Debug$toString};
var savardd$elm_time_travel$Sandbox$Increment = function (a) {
	return {$: 'Increment', a: a};
};
var savardd$elm_time_travel$Sandbox$init = {
	counter: 0,
	lastMsg: savardd$elm_time_travel$Sandbox$Increment(0),
	message: ''
};
var savardd$elm_time_travel$Sandbox$update = F2(
	function (msg, model) {
		switch (msg.$) {
			case 'Increment':
				var value = msg.a;
...
var savardd$elm_time_travel$Sandbox$Decrement = function (a) {
	return {$: 'Decrement', a: a};
};
var savardd$elm_time_travel$Sandbox$Message = function (a) {
	return {$: 'Message', a: a};
};
var savardd$elm_time_travel$Sandbox$view = function (model) {
	return A2(
		elm$html$Html$div,
		_List_Nil,
		_List_fromArray(
			[
				...
				_List_fromArray(
					[
						...
						savardd$elm_time_travel$Sandbox$Decrement(1))
					]),
				_List_fromArray(
					[
						elm$html$Html$text('-')
				...
				_List_fromArray(
					[
						elm$html$Html$Events$onClick(
						savardd$elm_time_travel$Sandbox$Increment(1))
					]),
				_List_fromArray(
					[
						elm$html$Html$text('+')
				...
				_List_fromArray(
					[
						elm$html$Html$Events$onInput(savardd$elm_time_travel$Sandbox$Message)
					]),
				_List_Nil)
			]));
};
