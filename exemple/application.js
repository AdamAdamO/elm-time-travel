...
var savardd$elm_time_travel$Application$LinkClicked = function (a) {
...
var savardd$elm_time_travel$Application$config = {modelToString: elm$core$Debug$toString, msgToString: elm$core$Debug$toString};
...
var savardd$elm_time_travel$Application$init = F3(
	function (flags, url, key) {
		return _Utils_Tuple2(
			A3(savardd$elm_time_travel$Application$Model, key, url, 0),
			elm$core$Platform$Cmd$none);
	});
var elm$core$Platform$Sub$batch = _Platform_batch;
var elm$core$Platform$Sub$none = elm$core$Platform$Sub$batch(_List_Nil);
var savardd$elm_time_travel$Application$subscriptions = function (_n0) {
...
var savardd$elm_time_travel$Application$update = F2(
	function (msg, model) {
		if (msg.$ === 'LinkClicked') {
...
var savardd$elm_time_travel$Application$viewLink = function (path) {
	return A2(
		elm$html$Html$li,
		_List_Nil,
		_List_fromArray(
...
var savardd$elm_time_travel$Application$view = function (model) {
	return {
		body: _List_fromArray(
			[
				...
				_List_fromArray(
					[
						savardd$elm_time_travel$Application$viewLink('/home'),
						savardd$elm_time_travel$Application$viewLink('/profile'),
						savardd$elm_time_travel$Application$viewLink('/reviews/the-century-of-the-self'),
						savardd$elm_time_travel$Application$viewLink('/reviews/public-opinion'),
						savardd$elm_time_travel$Application$viewLink('/reviews/shah-of-shahs')
					]))
			]),
...
var savardd$elm_time_travel$TimeTravel$Browser$wrapApplication = F2(
	function (_n0, _n1) {
