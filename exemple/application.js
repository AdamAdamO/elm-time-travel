...
var author$project$Application$LinkClicked = function (a) {
...
var author$project$Application$Model = F3(
	function (key, url, count) {
		return {count: count, key: key, url: url};
	});
...
var author$project$Application$init = F3(
	function (flags, url, key) {
		return _Utils_Tuple2(
			A3(author$project$Application$Model, key, url, 0),
			elm$core$Platform$Cmd$none);
	});
var elm$core$Platform$Sub$batch = _Platform_batch;
var elm$core$Platform$Sub$none = elm$core$Platform$Sub$batch(_List_Nil);
var author$project$Application$subscriptions = function (_n0) {
...
var author$project$Application$viewLink = function (path) {
	return A2(
		elm$html$Html$li,
		_List_Nil,
		_List_fromArray(
	...
	return {
		body: _List_fromArray(
			[
				...
				_List_fromArray(
					[
						author$project$Application$viewLink('/home'),
						author$project$Application$viewLink('/profile'),
						author$project$Application$viewLink('/reviews/the-century-of-the-self'),
						author$project$Application$viewLink('/reviews/public-opinion'),
						author$project$Application$viewLink('/reviews/shah-of-shahs')
					]))
			]),
...
var author$project$TimeTravel$Internal$View$userDocument = F2(
	function (userDocument_, model) {
		var _n0 = author$project$TimeTravel$Internal$Model$selectedItem(model);
		if (_n0.$ === 'Just') {
			var item = _n0.a;
			return userDocument_(item.model);
		} else {
			return {
				body: _List_fromArray(
					[
						elm$html$Html$text('Error: Unable to render')
					]),
...
var author$project$TimeTravel$Internal$View$document = F4(
	function (transformUserMsg, transformDebuggerMsg, userDocumentFunc, model) {
		var document_ = A2(author$project$TimeTravel$Internal$View$userDocument, userDocumentFunc, model);
		...
		var body_ = A2(
			elm$core$List$map,
			elm$html$Html$map(transformUserMsg),
			document_.body);
		return {
			body: _Utils_ap(body_, debug_),
			title: document_.title
		};
	});
var elm$core$Platform$Sub$map = _Platform_map;
var author$project$TimeTravel$Browser$wrapApplication = F2(
	function (_n0, _n1) {
		...
		var onUrlRequest = _n1.onUrlRequest;
		var onUrlChange = _n1.onUrlChange;
		var view_ = function (model) {
			return A4(
				author$project$TimeTravel$Internal$View$document,
				function (c) {
		...
		var onUrlRequest_ = function (url) {
			return author$project$TimeTravel$Browser$UserMsg(
				_Utils_Tuple2(
					elm$core$Maybe$Nothing,
					onUrlRequest(url)));
		};
		var onUrlChange_ = function (url) {
			return author$project$TimeTravel$Browser$UserMsg(
				_Utils_Tuple2(
					elm$core$Maybe$Nothing,
					onUrlChange(url)));
...
var author$project$TimeTravel$Browser$application = function (stuff) {
	var options = {
	...
	return elm$browser$Browser$application(
		A2(author$project$TimeTravel$Browser$wrapApplication, options, stuff));
};
var author$project$Application$main = author$project$TimeTravel$Browser$application(
	{init: author$project$Application$init, onUrlChange: author$project$Application$UrlChanged, onUrlRequest: author$project$Application$LinkClicked, subscriptions: author$project$Application$subscriptions, update: author$project$Application$update, view: author$project$Application$view});
