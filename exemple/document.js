...
var author$project$Document$AdjustTimeZone = function (a) {
	return {$: 'AdjustTimeZone', a: a};
};
var author$project$Document$Model = F2(
	function (zone, time) {
...
var author$project$Document$init = function (_n0) {
	return _Utils_Tuple2(
		A2(
			author$project$Document$Model,
			elm$time$Time$utc,
			elm$time$Time$millisToPosix(0)),
		A2(elm$core$Task$perform, author$project$Document$AdjustTimeZone, elm$time$Time$here));
};
var author$project$Document$Tick = function (a) {
	return {$: 'Tick', a: a};
};
...
var author$project$Document$subscriptions = function (model) {
	return A2(elm$time$Time$every, 1000, author$project$Document$Tick);
};
var elm$core$Platform$Cmd$batch = _Platform_batch;
var elm$core$Platform$Cmd$none = elm$core$Platform$Cmd$batch(_List_Nil);
var author$project$Document$update = F2(
	function (msg, model) {
		if (msg.$ === 'Tick') {
			var newTime = msg.a;
			return _Utils_Tuple2(
...
var author$project$Document$view = function (model) {
...
var author$project$TimeTravel$Browser$wrapDocument = F2(
	function (_n0, _n1) {
...
var author$project$TimeTravel$Browser$document = function (stuff) {
	var options = {
	...
	return elm$browser$Browser$document(
		A2(author$project$TimeTravel$Browser$wrapDocument, options, stuff));
};
var author$project$Document$main = author$project$TimeTravel$Browser$document(
	{init: author$project$Document$init, subscriptions: author$project$Document$subscriptions, update: author$project$Document$update, view: author$project$Document$view});
_Platform_export({'Document':{'init':author$project$Document$main(
