...
var savardd$elm_time_travel$Document$AdjustTimeZone = function (a) {
	return {$: 'AdjustTimeZone', a: a};
};
var savardd$elm_time_travel$Document$Model = F2(
	function (zone, time) {
		return {time: time, zone: zone};
	});
var savardd$elm_time_travel$Document$init = function (_n0) {
	return _Utils_Tuple2(
		A2(
			savardd$elm_time_travel$Document$Model,
			elm$time$Time$utc,
			elm$time$Time$millisToPosix(0)),
		A2(elm$core$Task$perform, savardd$elm_time_travel$Document$AdjustTimeZone, elm$time$Time$here));
};
...
var savardd$elm_time_travel$Document$Tick = function (a) {
	return {$: 'Tick', a: a};
};
var savardd$elm_time_travel$Document$subscriptions = function (model) {
	return A2(elm$time$Time$every, 1000, savardd$elm_time_travel$Document$Tick);
};
var elm$core$Platform$Cmd$batch = _Platform_batch;
var elm$core$Platform$Cmd$none = elm$core$Platform$Cmd$batch(_List_Nil);
var savardd$elm_time_travel$Document$update = F2(
	function (msg, model) {
		if (msg.$ === 'Tick') {
			var newTime = msg.a;
			return _Utils_Tuple2(
...
var savardd$elm_time_travel$Document$view = function (model) {
...
var savardd$elm_time_travel$TimeTravel$Browser$wrapDocument = F2(
	function (_n0, _n1) {
...
var savardd$elm_time_travel$TimeTravel$Browser$document = F2(
	function (config, stuff) {
		...
		return elm$browser$Browser$document(
			A2(savardd$elm_time_travel$TimeTravel$Browser$wrapDocument, options, stuff));
	});
var savardd$elm_time_travel$Document$main = A2(
	savardd$elm_time_travel$TimeTravel$Browser$document,
	savardd$elm_time_travel$Document$config,
	{init: savardd$elm_time_travel$Document$init, subscriptions: savardd$elm_time_travel$Document$subscriptions, update: savardd$elm_time_travel$Document$update, view: savardd$elm_time_travel$Document$view});
_Platform_export({'Document':{'init':savardd$elm_time_travel$Document$main(
